...
const className = "BitDecayEngine";

export interface BitDecayConfig {
  width: number;
  height: number;
  text: string;
  fontFamily?: string;
...
export class BitDecayEngine {
  private cfg: Required<BitDecayConfig>;

  constructor(config: BitDecayConfig) {
    // Merge provided configuration with static studio defaults
    const defaults: Required<BitDecayConfig> = {
      width: 800,
      height: 200,
      text: "SYSTEM ERR",
...
// ─── Definition ───────────────────────────────────────────────────────────────
export const BitDecayDefinition: TextEffectDefinition = {
  id: "bit-decay",
  name: "Bit Decay",
  text: "CLYPRA",
  category: "grunge",
