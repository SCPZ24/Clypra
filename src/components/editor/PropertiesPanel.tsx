...
export const PropertiesPanel: React.FC = () => {
  ...
  if (!selectedClipId || !selectedClip) {
    return (
      <div className="w-[23rem] min-h-0 panel-shell flex flex-col p-4 overflow-y-auto scrollbar-thin shrink-0 select-none">
          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-surface-raised border border-border/80 rounded-lg p-2.5 text-xs text-text-primary outline-none focus:border-accent resize-none selectable"
              />
            </div>
            ...
            <div>
              ...
              <div className="space-y-3 p-3 bg-surface-raised/20 border border-border/40 rounded-xl">
                ...
                <div>
                  ...
                  <select
                    value={normalizeFontFamily(textClip.fontFamily || "Inter Variable")}
                    onChange={(e) => handleUpdate("fontFamily", e.target.value)}
                    className="w-full bg-surface-raised border border-border rounded px-2.5 py-1.5 text-xs text-text-primary outline-none"
                  >
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <input
                      ...
                      value={textClip.fontSize || 48}
                      onChange={(e) => handleUpdate("fontSize", Number(e.target.value))}
                      className="w-12 bg-surface-raised border border-border rounded text-center py-0.5 text-xs text-text-primary outline-none"
                    />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3 pt-1">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="flex gap-1 bg-surface-raised border border-border/60 p-0.5 rounded">
                      <button
                        onClick={() => handleUpdate("fontWeight", textClip.fontWeight === "bold" ? "normal" : "bold")}
                        className={`flex-1 py-1 rounded text-xs font-bold transition-all ${
                          textClip.fontWeight === "bold" ? "bg-accent text-white" : "text-text-muted hover:text-text-primary"
                        }`}
                      >
                        B
                      </button>
                      <button
                        onClick={() => handleUpdate("fontStyle", textClip.fontStyle === "italic" ? "normal" : "italic")}
                        className={`flex-1 py-1 rounded text-xs italic transition-all ${
                          textClip.fontStyle === "italic" ? "bg-accent text-white font-bold" : "text-text-muted hover:text-text-primary"
                        }`}
                      >
                        I
                      </button>
                    ...
                    <div className="flex gap-1 bg-surface-raised border border-border/60 p-0.5 rounded">
                      <button
                        ...
                        className={`flex-1 py-1 rounded flex items-center justify-center transition-all ${
                          textClip.align === "left" ? "bg-accent text-white" : "text-text-muted hover:text-text-primary"
                        }`}
                      >
                      ...
                      <button
                        ...
                        className={`flex-1 py-1 rounded flex items-center justify-center transition-all ${
                          textClip.align === "center" || !textClip.align ? "bg-accent text-white" : "text-text-muted hover:text-text-primary"
                        }`}
                      >
                      ...
                      <button
                        ...
                        className={`flex-1 py-1 rounded flex items-center justify-center transition-all ${
                          textClip.align === "right" ? "bg-accent text-white" : "text-text-muted hover:text-text-primary"
                        }`}
                      >
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="flex gap-1 bg-surface-raised border border-border/60 p-0.5 rounded">
                      <button
                        onClick={() => handleUpdate("valign", "top")}
                        className={`flex-1 py-1 rounded flex items-center justify-center transition-all ${
                          textClip.valign === "top" ? "bg-accent text-white" : "text-text-muted hover:text-text-primary"
                        }`}
                      >
                        <AlignStartVertical className="w-3.5 h-3.5" />
                      </button>
                      <button
                        onClick={() => handleUpdate("valign", "middle")}
                        className={`flex-1 py-1 rounded flex items-center justify-center transition-all ${
                          textClip.valign === "middle" || !textClip.valign ? "bg-accent text-white" : "text-text-muted hover:text-text-primary"
                        }`}
                      >
                        <AlignCenterVertical className="w-3.5 h-3.5" />
                      </button>
                      <button
                        onClick={() => handleUpdate("valign", "bottom")}
                        className={`flex-1 py-1 rounded flex items-center justify-center transition-all ${
                          textClip.valign === "bottom" ? "bg-accent text-white" : "text-text-muted hover:text-text-primary"
                        }`}
                      >
                  ...
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      className="w-full bg-surface-raised border border-border rounded py-1 px-2 text-center text-xs text-text-primary outline-none"
                    />
                  </div>
                </div>
              ...
              <div className="space-y-3.5 p-3.5 bg-surface-raised/20 border border-border/40 rounded-xl">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <input
                      type="color"
                      value={(textClip.color || "#ffffff").includes(",") ? "#ffffff" : (textClip.color || "#ffffff")}
                    ...
                    <div className="space-y-2 p-2 bg-surface-raised/40 rounded-lg">
                      <div className="flex items-center justify-between">
                        ...
                        <input
                          ...
                          onChange={(e) => handleUpdate("stroke", { ...textClip.stroke, color: e.target.value })}
                      ...
                      <div>
                        ...
                        <input
                          ...
                          min="1"
                          max="15"
                          value={textClip.stroke.width}
                          onChange={(e) => handleUpdate("stroke", { ...textClip.stroke, width: Number(e.target.value) })}
                    ...
                    <div className="space-y-2 p-2 bg-surface-raised/40 rounded-lg">
                      <div className="flex items-center justify-between">
                        ...
                        <input
                          ...
                          onChange={(e) => handleUpdate("shadow", { ...textClip.shadow, color: e.target.value })}
                          className="w-6 h-6 bg-transparent border-0 cursor-pointer"
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          min="1"
                          max="30"
                          value={textClip.shadow.blur}
                          onChange={(e) => handleUpdate("shadow", { ...textClip.shadow, blur: Number(e.target.value) })}
                          className="w-full accent-accent"
                        />
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <div>
                          ...
                          <input
                            type="number"
                            value={textClip.shadow.offsetX}
                            onChange={(e) => handleUpdate("shadow", { ...textClip.shadow, offsetX: Number(e.target.value) })}
                            className="w-full bg-surface-raised border border-border text-center rounded py-0.5 text-xs text-text-primary outline-none"
                          />
                        </div>
                        <div>
                          ...
                          <input
                            type="number"
                            value={textClip.shadow.offsetY}
                            onChange={(e) => handleUpdate("shadow", { ...textClip.shadow, offsetY: Number(e.target.value) })}
                            className="w-full bg-surface-raised border border-border text-center rounded py-0.5 text-xs text-text-primary outline-none"
                          />
                        </div>
                      </div>
                  ...
                  {textClip.background && (
                    <div className="space-y-2 p-2 bg-surface-raised/40 rounded-lg">
                      <div className="flex items-center justify-between">
                        ...
                        <input
                          type="color"
                          value={textClip.background.color.startsWith("rgba") ? "#000000" : textClip.background.color}
                          onChange={(e) => handleUpdate("background", { ...textClip.background, color: e.target.value })}
                          className="w-6 h-6 bg-transparent border-0 cursor-pointer"
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          min="0"
                          max="30"
                          value={textClip.background.padding}
                          onChange={(e) => handleUpdate("background", { ...textClip.background, padding: Number(e.target.value) })}
                          className="w-full accent-accent"
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          min="0"
                          max="25"
                          value={textClip.background.borderRadius}
                          onChange={(e) => handleUpdate("background", { ...textClip.background, borderRadius: Number(e.target.value) })}
                          className="w-full accent-accent"
                        />
                      </div>
              ...
              <div className="grid grid-cols-3 gap-2 bg-surface-raised/10 border border-border/40 p-2.5 rounded-xl">
                {TEXT_EFFECTS.slice(0, 6).map((effect) => (
                  <button
                    ...
                    className="p-2 rounded bg-surface-raised border border-border hover:border-accent text-center truncate text-[10px] text-text-primary font-bold shadow-[0_2px_4px_rgba(0,0,0,0.15)] transition-all cursor-pointer truncate max-w-[90px]"
                    style={{
                      fontFamily: effect.fontFamily,
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) => handleApplyFit(e.target.value as ClipFitModeExtended)}
                    ...
                    <div className="flex items-end">
                      <button
                        ...
                        className="w-full bg-surface-raised border border-border rounded px-2 py-1 text-xs text-text-primary hover:bg-white/6 transition-all active:scale-[0.97]"
                      >
                        Reset Fit
                      </button>
                    </div>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <input
                      ...
                      onChange={(e) => handleUpdate("rotation", Number(e.target.value))}
                      className="w-12 bg-surface-raised border border-border rounded px-2 py-0.5 text-xs text-text-primary text-center outline-none"
                    />
                  </div>
                </div>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-surface-raised border border-border rounded px-2.5 py-1 text-xs text-text-primary outline-none"
                  />
                </div>
